 ...
 * </p>
 * <ul>
 *   <li>{@link python.impl.ConstantReferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstantReferenceImpl extends ExpressionImpl implements ConstantReference {
	...
	protected EClass eStaticClass() {
		return PythonPackage.Literals.CONSTANT_REFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonPackage.CONSTANT_REFERENCE__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PythonPackage.CONSTANT_REFERENCE__NAME:
			return getName();
		}
