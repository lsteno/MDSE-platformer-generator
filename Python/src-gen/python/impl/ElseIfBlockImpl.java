 ...
 * </p>
 * <ul>
 *   <li>{@link python.impl.ElseIfBlockImpl#getScript <em>Script</em>}</li>
 *   <li>{@link python.impl.ElseIfBlockImpl#getBooleanexpression <em>Booleanexpression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElseIfBlockImpl extends MinimalEObjectImpl.Container implements ElseIfBlock {
	...
	protected EClass eStaticClass() {
		return PythonPackage.Literals.ELSE_IF_BLOCK;
	}
	...
	public NotificationChain basicSetScript(Script newScript, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PythonPackage.ELSE_IF_BLOCK__SCRIPT, oldScript, newScript);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newScript != script) {
			...
			if (script != null)
				msgs = ((InternalEObject) script).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PythonPackage.ELSE_IF_BLOCK__SCRIPT, null, msgs);
			if (newScript != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PythonPackage.ELSE_IF_BLOCK__SCRIPT, newScript,
					newScript));
	}
	...
	public NotificationChain basicSetBooleanexpression(BooleanExpression newBooleanexpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PythonPackage.ELSE_IF_BLOCK__BOOLEANEXPRESSION, oldBooleanexpression, newBooleanexpression);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newBooleanexpression != booleanexpression) {
			...
			if (booleanexpression != null)
				msgs = ((InternalEObject) booleanexpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PythonPackage.ELSE_IF_BLOCK__BOOLEANEXPRESSION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PythonPackage.ELSE_IF_BLOCK__BOOLEANEXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PythonPackage.ELSE_IF_BLOCK__SCRIPT:
			return basicSetScript(null, msgs);
		case PythonPackage.ELSE_IF_BLOCK__BOOLEANEXPRESSION:
