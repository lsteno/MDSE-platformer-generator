 ...
 * </p>
 * <ul>
 *   <li>{@link platformer.impl.LivesImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LivesImpl extends MinimalEObjectImpl.Container implements Lives {
	...
	protected EClass eStaticClass() {
		return PlatformerPackage.Literals.LIVES;
	}
	...
	public void setAmount(int newAmount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformerPackage.LIVES__AMOUNT, oldAmount, amount));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PlatformerPackage.LIVES__AMOUNT:
			return getAmount();
		}
