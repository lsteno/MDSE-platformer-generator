 ...
 * </p>
 * <ul>
 *   <li>{@link platformer.impl.PlatformImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlatformImpl extends EntityImpl implements Platform {
	 ...
	 * @ordered
	 */
	protected static final PlatformType TYPE_EDEFAULT = PlatformType.STILL;
	...
	protected EClass eStaticClass() {
		return PlatformerPackage.Literals.PLATFORM;
	}
	...
	public void setType(PlatformType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformerPackage.PLATFORM__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PlatformerPackage.PLATFORM__TYPE:
			return getType();
		}
